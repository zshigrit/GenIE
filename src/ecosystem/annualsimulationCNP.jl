function annual_simulationCNP!(
    ...
    ippar::IPPar,oppar::OPPar,ip::MPPools,ppools::Pools,rCP::Pools
)
...
for iyearr in 1:9*1
    ...
    for iday in 1:365
	    ...
	    for ihour in 1:24
               ...
               plantsoilcnp!(par_base,soil,plant,weather,ip,oppar,ippar,ppools,rCP)
